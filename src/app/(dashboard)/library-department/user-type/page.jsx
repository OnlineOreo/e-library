...
const ViewUserType = () => {
  ...
  const filteredUserType = userType.map((inst) => ({
    ...inst,
    created_at: moment(inst.created_at).format("MMMM D, YYYY, h:mm A"),
    updated_at: moment(inst.updated_at).format("MMMM D, YYYY, h:mm A"),
  })).filter((inst) =>
