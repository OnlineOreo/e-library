        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    Swal.fire("Deleted!", "Staff Recommendation has been deleted.", "success");
                    loadStaffPick();
                } catch (error) {
                ...
                <Row>
                    <Col lg={12} md={12} xs={12} className="mb-4">
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <Link href="./staff-recommendation/add" className="btn btn-white">
                ...
                <div className="card p-3 mt-4">
                    ...
                    <Box sx={{ height: 500, width: "100%" }}>
                        {isLoading ? (
                            ...
                            <p>No Staff Pick configurations found.</p>
                        )}
                    </Box>
                </div>
