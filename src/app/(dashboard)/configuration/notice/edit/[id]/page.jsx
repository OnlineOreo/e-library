...
const AddCategory = () => {
    ...
    const loadNotices = async () => {
        ...
        try {
          const response = await axios.get(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/notices?notice_id=${prop.id}`, {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.put(
                `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/notices?notice_id=${prop.id}`,
                formDataToSend,
                {
                    headers: {
                        Authorization: `${token}`,
                ...
                <Row>
                    <Col lg={12}>
                        <div className="d-flex justify-content-between align-items-center">
                            <h3 className="mb-0 text-dark">Edit Notice</h3>
