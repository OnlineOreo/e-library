            ...
            <div className="container py-5 px-lg-5">
                <div className="row g-5 align-items-center">
                    <div className="col-lg-7 wow fadeInUp" data-wow-delay="0.3s">
                        <h5 className="text-primary-gradient fw-medium" id="download_heading">Download</h5>
                    ...
                    <div className="col-lg-5 d-flex justify-content-center justify-content-lg-end">
                        <div className="owl-carousel screenshot-carousel" style={{ maxHeight: '500px', overflow: 'hidden', borderRadius: '20px' }}>
                            <Swiper
                            ...
                            >
                                {screenshots.map((src, index) => (
                                    <SwiperSlide key={index}>
                                        <img className="img-fluid" src={src} alt={`Screenshot ${index + 1}`} style={{ maxHeight: '480px', objectFit: 'contain', borderRadius: '20px' }} />
                                    </SwiperSlide>
                                ))}
                            </Swiper>
                        </div>
