...
export default function PrintCollectionSavedCatalog() {
    ...
    const handleLoadMore = async () => {
        ...
        try {
            const res = await fetch(`/internal-api/load-more?q=${solrQuery}&start=${nextStart}&catalogCore=e-collection&rows=12`);
    ...
    const loadReadHistory = async () => {
        ...
        try {
            ...
            const catalogIds = finalResult.saved_e_collection_ids;
