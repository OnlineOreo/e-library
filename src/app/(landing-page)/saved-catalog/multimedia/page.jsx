...
export default function PrintCollectionSavedCatalog() {
    ...
    const handleLoadMore = async () => {
        setIsLoading(true);
        const catalogIds = userSavedCatalogs.saved_multimedia_ids;
        ...
        try {
            const res = await fetch(`/internal-api/load-more?q=${solrQuery}&start=${nextStart}&catalogCore=multimedia-n&rows=12`);
