...
import MultimediaContentAdv from './MultimediaContent';
...
async function fetachSolrData(searchQuery, startIndex = 0) {
  ...
  try {
    const solrUrl = `${process.env.NEXT_PUBLIC_SOLR_BASE_URL}/solr/multimedia-n/select?indent=true&q.op=OR&q=${searchQuery}&rows=20&start=${startIndex}`;
